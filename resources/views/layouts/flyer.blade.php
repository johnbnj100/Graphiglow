          ...
          <div class="main pb-20" style="background-image: url(assets/kpd/back.jpeg);background-size: cover;">
            <div id="drag-container" class="py-20" >
               <div id="spin-container" class="py-10">
                 ...
                 <img src="\assets\kpd\flyer.jpeg" class="">
                 <img src="\assets\kpd\church5.jpeg" class="">
                 <img src="\assets\kpd\flyer2.jpeg" class="" >
                 <img src="\assets\kpd\church.jpeg" class="" >
                 <img src="\assets\kpd\church3.jpeg" class="" >
                 <img src="\assets\kpd\church2.jpeg" class="">
                 <img src="\assets\kpd\flyer3.jpeg" class="">


                 <p class="font-bold text-4xl">Flyer Programme</p>
                 </div>
                       ...
                       <form action="/flyers" method="POST" enctype="multipart/form-data">
                        ...
                        <div class="col-12 pb-10">
                          ...
                          <div class="col-12 pb-10">
                            ...
                            value="{{old('type')}}" placeholder="Color Type" required>
                            @error('type')
                            <p class="text-red text-xl">{{$message}}</p>
                            @enderror
                          </div>
                          ...
                          <div class="col-12 pb-10">
                           ...
                           <div class="mb-3 pb-2 col-12">
                             ...
                             <input type="file" class="form-control form-control-md" id="address2" name="flyer[]" multiple aria-label="Small file input example" required>
                           </div>
