...
<div id="test" class="morphbutton-content rounded-2xl px-10" style="background-image: url(assets/kpd/nest.jpeg); background-size: cover; line-height: 30px;">
    ...
    <div class="py-2">
        ...
        <h2 class="font-bold text-dark py-2" style="border-bottom: 2px solid black; font-family: poppin, Verdana, Geneva, Tahoma, sans-serif"> DOCUMENTS </h2>
            <div class="lg:flex justify-center py-10 block ">

                 @php
                    $doc = explode('|', $layout->documents);
                    @endphp
                    @foreach ($doc as $item)
                    <p class=" px-4 py-3 mx-auto text-center" >{{$item}}</p>
                @endforeach
            </div>
        </div>
        </div>
    ...
    <div class="pb-20">
        ...
        <h2 class="font-bold text-dark py-2" style="border-bottom: 2px solid black; font-family: poppin, Verdana, Geneva, Tahoma, sans-serif"> DESIGN </h2>
            <div class="lg:flex justify-center  py-10 block ">

                 @php
                    $image = explode('|', $layout->business);
                    @endphp
