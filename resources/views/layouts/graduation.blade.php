        ...
        <div class="main pb-20" style="background-image: url(assets/kpd/back.jpeg);background-size: cover;">
            <div id="drag-container" class="py-20" >
               <div id="spin-container" class="py-10">
                 ...
                 <img src="\assets\kpd\graduation.jpeg" class="">
                 <img src="\assets\kpd\graduation2.jpeg" class="">
                 <img src="\assets\kpd\graduation3.jpeg" class="" >
                 <img src="\assets\kpd\graduation4.jpeg" class="" >
                 <img src="\assets\kpd\jotter.jpeg" class="" >
                 <img src="\assets\kpd\jotter2.jpeg" class="">
                 <img src="\assets\kpd\jotter4.jpeg" class="">
                 <p class="font-bold text-4xl">Graduation Programme</p>
                 </div>
                 <div id="ground"></div>
               </div>
           </div>
                   ...
                   <div class="col-md-5 col-lg-4 order-md-last">
                     ...
                     <ul class="list-group mb-3 py-8">
                       <li class="list-group-item d-flex justify-content-between lh-sm">
                         <div>
                           <h6 class="my-0">Graduation Programme</h6>
                     ...
                     <form action="/graduate" method="POST" enctype="multipart/form-data">
                      ...
                      <div class="col-12 pb-10">
                        <label for="address2" class="form-label text-white">LGA</span></label>
                         ...
                         <div class="col-12 pb-10">
                           <label for="address2" class="form-label text-white">Name</span></label>
                         ...
                         <div class="col-12 pb-10">
                            <label for="address2" class="form-label text-white"> Pages</span></label>
                            <input type="text" class="form-control border-dark" id="address2"  name="pages"
                            value="{{old('pages')}}" placeholder="How many Pages is the Job?" required>
                            @error('pages')
                            <p class="text-red text-xl">{{$message}}</p>
                            @enderror
                          </div>
                         ...
                         <div class="col-12 pb-10">
                            <label for="address2" class="form-label text-white">Paper Size</span></label>
                            <select class="form-control form-select-lg mb-3" aria-label=".form-select-lg example" name="size">
                                @foreach ($product as $products)
                                 <option>{{$products['A5']}}</option>
                                 <option>{{$products['A4']}}</option>
                                 <option>{{$products['A3']}}</option>
                                @endforeach
                               </select>
                          </div>
                          ...
                          <div class="mb-3 pb-2 col-12">
                            <label for="address2" class="form-label text-white"> Documents </span></label>
                            <input type="file" class="form-control form-control-md" id="address2" name="documents[]" multiple aria-label="Small file input example" required>
                          </div>

                         <div class="mb-3 pb-2 col-12">
                           <label for="address2" class="form-label text-white"> Upload Design </span></label>
                           <input type="file" class="form-control form-control-md" id="address2" name="logo6[]" multiple aria-label="Small file input example" required>
                         </div>
