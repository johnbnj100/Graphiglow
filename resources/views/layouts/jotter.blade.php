          ...
          <div class="main pb-20" style="background-image: url(assets/kpd/back.jpeg);background-size: cover;">
            <div id="drag-container" class="py-20" >
               <div id="spin-container" class="py-10">
                 ...
                 <img src="\assets\kpd\jotter3.jpeg" class="" >
                 <img src="\assets\kpd\jotter4.jpeg" class="" >
                 <img src="\assets\kpd\jotter5.jpeg" class="" >
                 <img src="\assets\kpd\jotter6.jpeg" class="">
                 <img src="\assets\kpd\jotter4.jpeg" class="">

                 <p class="font-bold text-4xl"> Jotter</p>
                 </div>
                 <div id="ground"></div>
               </div>
           </div>
                 ...
                 <main class="container rounded-2xl px-10 py-10" style="background-image: url(assets/kpd/back.jpeg);background-size: cover;">
                   ...
                   <div class="row g-5 px-10">
                     ...
                     <div class="col-md-7 col-lg-8">
                       ...
                       <form action="/jotters" method="POST" enctype="multipart/form-data">
                         @csrf
                         <div class="row g-3">
                        ...
                        <div class="col-12 pb-10">
                          ...
                          <div class="col-12 pb-10">
                            <label for="address2" class="form-label text-white"> Style</span></label>
                            <select class="form-control form-select-lg " aria-label=".form-select-lg example" name="style">
                                @foreach ($product as $plates)
                                <option>{{$plates['spiral']}}</option>
                                 <option>{{$plates['board']}}</option>
                                @endforeach
                               </select>
                          </div>
                           ...
                           <div class="mb-3 pb-2 col-12">
                             ...
                             <input type="file" class="form-control form-control-md" id="address2" name="jotter[]" multiple aria-label="Small file input example" required>
                           </div>
