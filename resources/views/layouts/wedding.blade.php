        ...
        <div class="main pb-20" style="background-image: url(assets/kpd/back.jpeg);background-size: cover;">
            <div id="drag-container" class="py-20" >
               <div id="spin-container" class="py-10">
                 ...
                 <img src="\assets\kpd\wedding.jpeg" class="">
                 <img src="\assets\kpd\wedding4.jpeg" class="">
                 <img src="\assets\kpd\wedding5.jpeg" class="" >
                 <img src="\assets\kpd\wedding6.jpeg" class="" >
                 <img src="\assets\kpd\wedding7.jpeg" class="" >
                 <img src="\assets\kpd\wedding8.jpeg" class="">
                 <img src="\assets\kpd\wedding2.jpeg" class="">

                 <p class="font-bold text-4xl">Wedding Programme</p>
                 </div>
                 <div id="ground"></div>
               </div>
           </div>
               ...
               <main class="container rounded-2xl px-10 py-10" style="background-image: url(assets/kpd/back.jpeg);background-size: cover;">
                 ...
                 <div class="row g-5 px-10">
                   <div class="col-md-5 col-lg-4 order-md-last">
                     ...
                     <ul class="list-group mb-3 py-8">
                       <li class="list-group-item d-flex justify-content-between lh-sm">
                         <div>
                           <h6 class="my-0">Wedding Programme</h6>
                   ...
                   <div class="col-md-7 col-lg-8">
                     ...
                     <form action="/weddings" method="POST" enctype="multipart/form-data">
                       @csrf
                       <div class="row g-3">
                      ...
                      <div class="col-12 pb-10">
                        <label for="address2" class="form-label text-white">LGA</span></label>
                         ...
                         <div class="mb-3 pb-2 col-12">
                           ...
                           <input type="file" class="form-control form-control-md" id="address2" name="logo8[]" multiple aria-label="Small file input example" required>
                         </div>
