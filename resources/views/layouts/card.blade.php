        ...
        <div class="main pb-20" style="background-image: url(assets/kpd/back.jpeg);background-size: cover;">
            <div id="drag-container" class="py-20" >
               <div id="spin-container" class="py-10">
                 ...
                 <img src="\assets\kpd\card.jpeg" class="">
                 <img src="\assets\kpd\card3.jpeg" class="">
                 <img src="\assets\kpd\card4.jpeg" class="" >
                 <img src="\assets\kpd\card5.jpeg" class="" >
                 <img src="\assets\kpd\card6.jpeg" class="" >
                 <img src="\assets\kpd\card7.jpeg" class="">
                 <img src="\assets\kpd\card2.jpeg" class="">

                 <p class="font-bold text-4xl">Business-Card Programme</p>
                 </div>
                 <div id="ground"></div>
               </div>
           </div>
                   ...
                   <div class="col-md-5 col-lg-4 order-md-last">
                     ...
                     <ul class="list-group mb-3 py-8">
                       <li class="list-group-item d-flex justify-content-between lh-sm">
                         <div>
                           <h6 class="my-0">Business-Card</h6>
                        ...
                        <label for="address2" class="form-label text-white">LGA</span></label>
                         ...
                         <div class="col-12 pb-10">
                          ...
                          <div class="col-12 pb-10">
                            ...
                            value="{{old('type')}}" placeholder="Color" required>
                            @error('type')
                            <p class="text-red text-xl">{{$message}}</p>
                            @enderror
                          </div>
                         ...
                         <div class="col-12 pb-10">
                           <label for="address2" class="form-label text-white">Card Quantity</span></label>
                           <input type="text" class="form-control border-dark" id="address2"  name="quantity"
                           value="{{old('quantity')}}" placeholder="Numbers of Card" required>
                           @error('quantity')
                           <p class="text-red text-xl">{{$message}}</p>
                           @enderror
                         </div>
                         ...
                         <div class="mb-3 pb-2 col-12">
                           ...
                           <input type="file" class="form-control form-control-md" id="address2" name="logo9[]" multiple aria-label="Small file input example" required>
                         </div>
