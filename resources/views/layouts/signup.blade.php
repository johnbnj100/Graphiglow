...
<div class="w-full px-4 lg:w-1/2 xl:w-5/12 mx-auto py-20">
    ...
    <h1 class="text-center text-xl text-white mx-auto container py-10 font-bold">CREATE ACCOUNT</h1>
      ...
      @enderror
        ...
        <p class="text-xl text-center text-white py-3">Already have an account?<a href="/signin"> Sign in</a></p>
      </form>
    </div>
</div>
</div>
