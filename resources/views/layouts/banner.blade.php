...
<div class="main pb-20" style="background-image: url(assets/kpd/back.jpeg);background-size: cover;">
 <div id="drag-container" class="py-20" >
    <div id="spin-container" class="py-10">
      ...
      <img src="\assets\kpd\roll.jpeg" class="">
      <img src="\assets\kpd\banner2.jpeg" class="">
      <img src="\assets\kpd\three.jpeg" class="" >
      <img src="\assets\kpd\two.jpeg" class="" >
      <img src="\assets\kpd\photo.jpeg" class="" >
      <img src="\assets\kpd\banner3.jpeg" class="">
      <img src="\assets\kpd\banner.jpeg" class="">

      <p class="font-bold text-4xl">Banner</p>
      </div>
      <div id="ground"></div>
    </div>
</div>
    ...
    <x-flash />
        <div class="pb-20">
        <div class="py-20">
        <main class="container rounded-2xl px-10 pb-10" style="background-image: url(assets/kpd/back.jpeg);background-size: cover;">
              ...
              <form action="/storage" method="POST" enctype="multipart/form-data">
                ...
                <div class="row g-3">
                  ...
                  <div class="col-12 pb-10">
                    ...
                    <input type="text" class="form-control border-dark" id="address2"  name="phone" value="{{old('phone')}}" placeholder="Number" required>
                    <div class="invalid-feedback">
                ...
                <div class="col-12 pb-10">
                  ...
                  <div class="col-12 pb-10">
                    <label id="address" class="form-label text-white">Delivery Address</label>
                    <input type="text" class="form-control border-dark" id="input" name="address"
                  ...
                  <div class="col-12 pb-10">
                    <label for="address2" class="form-label text-white">SAV Name</span></label>
                    <input type="text" class="form-control border-dark" id="address2"  name="savname"
                    value="{{old('savname')}}" placeholder="SavName" required>
                    @error('savname')
                    <p class="text-red text-xl">{{$message}}</p>
                    @enderror
                  </div>
                  ...
                  <div class="col-12 pb-10">
                    <label for="address2" class="form-label text-white">SAV Quantity</span></label>
                    <input type="text" class="form-control border-dark"  name="quantity"
                    value="{{old('quantity')}}" placeholder="Numbers of SAV" required>
                    @error('savname')
                    <p class="text-red text-xl">{{$message}}</p>
                    @enderror
                  </div>
                  ...
                  <div class="mb-3 pb-2 col-12">
                    ...
                    <input type="file" class="form-control form-control-md" id="address2" name="logo[]" multiple aria-label="Small file input example" required>
                    @error('logo[]')
                    <p class="text-red text-xl">{{$message}}</p>
                    @enderror
                  </div>
